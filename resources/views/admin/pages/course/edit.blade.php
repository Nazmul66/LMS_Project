                ...
                <div class="col-lg-12">
                    ...
                    <form action="{{ route('admin.course.update', $course->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row align-items-end">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <img src="{{ !empty($course->image) ? asset($course->image) : asset('adminpanel/images/demo-icon.png') }}" class="d-block" alt="" for="up_image" style="width: 75px; height: 75px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <img src="{{ !empty($course->instructor_image) ? asset($course->instructor_image) : asset('adminpanel/images/demo-icon.png') }}" class="d-block" alt="" for="up_image" style="width: 75px; height: 75px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input name="designation" id="designation" class="form-control"
                                        placeholder="Write here....." type="text"
                                        value="{{ old('designation', $course->designation) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input name="course_level" id="course_level" class="form-control"
                                        placeholder="Write here....." type="text"
                                        value="{{ old('course_level', $course->course_level) }}">
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="description" class="form-label">Description <span
                                        class="text-danger">*</span></label>
                                <textarea class="form-control" name="description" id="description" placeholder="Write description here...." rows="8">{{ old('description', $course->description) }}</textarea>
                            </div>
                        </div>
