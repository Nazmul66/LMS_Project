...
@section('content')
    ...
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('admin.instructor.index') }}" class="btn btn-primary waves-effect waves-light">Back</a>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ route('admin.instructor.update', $row->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="name" id="name" placeholder="Write here...." type="text" class="form-control" value="{{ old('name', $row->name) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="designation" class="form-label">Designation <span
                                            class="text-danger">*</span></label>
                                    <input name="designation" id="designation" placeholder="Write here...." type="text" class="form-control" value="{{ old('designation', $row->designation) }}">
                                </div>
                            </div>
