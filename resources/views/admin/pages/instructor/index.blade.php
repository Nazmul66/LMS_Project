        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ route('admin.instructor.section.update', $section->id) }}" method="POST"
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h4 class="mb-sm-0 font-size-18">Instructor List</h4>
                <a href="{{ route('admin.instructor.create') }}" class="btn btn-primary waves-effect waves-light">Add New</a>
            </div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="{{ route('admin.instructor.edit', $row->id) }}"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.instructor.delete', $row->id) }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary text-white">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">View Instructor List
                                            </h1>
