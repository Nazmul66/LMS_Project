...
@section('content')
    ...
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('admin.features.index') }}" class="btn btn-primary waves-effect waves-light">Back</a>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ route('admin.features.update', $row->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="content" id="content" placeholder="Write description here...." rows="8">{{ old('content', $row->content) }}</textarea>
                                </div>
                            </div>
                        </div>
